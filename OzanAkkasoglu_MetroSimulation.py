...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        # BFS için kuyruk oluştur: (istasyon, rota) tuple'ları
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        # A* için öncelik kuyruğu: (toplam_sure, id(istasyon), istasyon, rota) tuple'ları
        ...
        while pq:
            ...
            # Eğer bu istasyona daha önce daha düşük maliyetle ulaşıldıysa atla
            if mevcut in ziyaret_edildi and toplam_sure > maliyet[mevcut]:
                continue
            ...
            for komsu, sure in mevcut.komsular:
                ...
                # Eğer bu komşuya daha önce ulaşılmadıysa veya daha düşük maliyetle ulaşılabiliyorsa
                if komsu not in maliyet or yeni_sure < maliyet[komsu]:
                    maliyet[komsu] = yeni_sure
                    yeni_rota = rota + [komsu]
